        ...
        <div className='sub-menu-container'>
            ...
            <div className="sub-menu-infomation">
                ...
                <div className="sub-menu-row">
                    ...
                    <div className='right-action' onClick={handleClickOpenFeedback}><strong><u className='underline-blue'>Tạo đánh giá của bài dạy</u></strong></div>
                </div>
                <div className="sub-menu-row">
                    <div><strong>Dung lượng: </strong> 19/9 KB</div>
                    <div className='right-action' onClick={() => { navigate(`/sub-menu-5/detail-view/${location.pathname.split('/')[3]}`) }}><strong><u className='underline-blue'>Đi đến phụ lục đánh giá của bài dạy</u></strong></div>
                </div>
                <div className="sub-menu-row">
                    <div><strong>Dung lượng: </strong> 19/9 KB</div>
                    <div className='right-action' onClick={() => { navigate('/sub-menu/5') }}><strong><u className='underline-blue'>Xem các đánh giá khác</u></strong></div>
                </div>
                <div className="sub-menu-row">
